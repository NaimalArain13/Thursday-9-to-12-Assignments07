...
export default async function ServerComponent() {
  ...
  return (
    <div className="min-h-screen container flex flex-col items-center justify-center w-full mx-auto p-4">
        <h1 className="text-3xl font-bold md:font-extrabold py-4 bg-gradient-to-t from-lime-300 to-purple-700 leading-snug bg-clip-text text-transparent">SERVER SIDE DATA FETCHING</h1>
